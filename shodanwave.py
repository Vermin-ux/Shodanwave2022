...
def main() :
 ...
 parser.add_argument('-u','--username', dest="username",  type=open, help='Select your usernames wordlist')
 parser.add_argument('-w','--wordlist', dest="password",  type=open, help='Select your passwords wordlist')
 ...
 def NetworkSearchosts():
  ...
  try:
   ...
   ShodanModuleExploit = input(backgroundColor.WARNING + "[!] Disable password discovery module? (Yes/no): " + backgroundColor.ENDC)
